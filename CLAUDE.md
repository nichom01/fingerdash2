...
- **Entitlements File**: `Config/Fingerdash2.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/Fingerdash2.entitlements`:
